...
class MySshClient():
    ...
    def push2gateway(self):
        ...
        self.g = Gauge('gene_push', 'status',
                       ['store_name', 'client_IP', 'snapshot_time', 'read_bytes', 'write_bytes'],
        ...
        for dict_tmp in dict_list:
            ...
            self.g.labels(store, client_IP, snapshot_time, read_bytes, write_bytes)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--command', default='cd /home/python/workspace/ssh_paramiko/oss_pushgate4; python generate1.py')
